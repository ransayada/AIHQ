    ...
    <div className="min-h-screen bg-[var(--color-studio-900)] text-[var(--color-studio-50)] flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--color-studio-300)] mt-1">Free during open beta. No credit card required.</p>
        </div>
        ...
        <p className="text-center text-sm text-[var(--color-studio-300)] mt-6">
          ...
          <Link href="/sign-in" className="text-[var(--color-accent-purple)] hover:opacity-80 font-medium">
            Sign in
          </Link>
        </p>
      </div>
